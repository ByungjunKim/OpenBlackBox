...
```{r}
tssci_socio <- vroom('../Data/TSSCI_Sociology.csv')
tssci_econo <- vroom('../Data/TSSCI_Economics.csv')
tssci_geo <- vroom('../Data/TSSCI_Geography.csv')
tssci_buss <- vroom('../Data/TSSCI_Management.csv')
tssci_polit <- vroom('../Data/TSSCI_Political Science.csv')
```
